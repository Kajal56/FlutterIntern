    ...
    return Container(
      ...
      child: Card(
        ...
        child: ListTile(
          ...
          leading: Image.network('https://th.bing.com/th/id/OIP._ubz9GoDT3pynMo3T2IwggHaHa?pid=ImgDet&rs=1'),
          ...
          title: Padding(
            ...
            child: Text(lawcase.personA+" vs "+ lawcase.personB,
            style: TextStyle(
              fontSize: 10
            ),),
          ),
          ...
          // trailing: Text(lawcase.courtname),
